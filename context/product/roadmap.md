...
- [ ] **Budget Controls**
  - [ ] **Per-Category Budget Limits:** Users set a monthly spending ceiling for any category. The app alerts them when they approach or exceed the limit.

- [ ] **Dashboard & Overview**
  - [ ] **At-a-Glance Financial Summary:** A primary dashboard showing total income, total expenses, net balance, and a spending breakdown by category for the current period.
...
- [ ] **Multi-Currency Workspace** — Track transactions in multiple currencies within a single workspace, designed for travelers and users with cross-border finances.
